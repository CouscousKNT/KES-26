...
export function ContactHeader() {
  return (
    <header
      className="riize-anim-1 flex items-center gap-2 border-b-2 px-1 pb-2.5 pt-1.5"
      style={{
        ...pixelFont,
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <div
          className="flex h-[22px] w-[26px] items-center justify-center rounded-[5px] border text-xs"
          style={{
            ...S.iconChip,
            borderColor: "rgba(30,80,160,0.5)",
            color: "#1c4a8a",
          }}
          aria-hidden="true"
        >
        ...
        <div
          className="riize-battery relative flex h-5 w-9 items-center gap-[2px] rounded-[3px] border-[1.5px] p-[2px]"
