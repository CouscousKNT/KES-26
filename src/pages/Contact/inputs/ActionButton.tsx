...
export function ActionButton({ buttonType, onClick }: ActionButtonProps) {
  const isSend = buttonType === "send";
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={onClick}
        className="reflect relative flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-[10px] border px-3.5 py-3 text-[17px] transition-transform duration-100 hover:-translate-y-px active:translate-y-px"
        style={{ ...pixelFont, ...styles[buttonType] }}
      >
        {isSend ? (
          <>
            <span
